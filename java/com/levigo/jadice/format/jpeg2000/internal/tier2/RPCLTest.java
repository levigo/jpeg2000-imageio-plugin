...
import static com.levigo.jadice.format.jpeg2000.internal.tier2.ProgressionOrder.RPCL;

import com.levigo.jadice.format.jpeg2000.internal.codestream.PacketHeader;

public class RPCLTest extends ProgressionOrderTestBase {

  @Override
  protected PacketJigsaw createPacketJigsaw() {
    final PacketJigsaw order = new PacketJigsaw(RPCL);
