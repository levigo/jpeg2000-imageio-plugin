...
public class POC extends AbstractMarkerSegment {
   ...
   * bits depending on {@link org.jadice.jpeg2000.internal.marker.SIZ#Csiz} value). One value for each
   ...
   * org.jadice.jpeg2000.internal.marker.SIZ#Csiz} value). One value for each progression change in this
   * tile or tile-part. The number of progression changes can be derived from the length of the marker segment.
   */
  public int[] CEpoc;
