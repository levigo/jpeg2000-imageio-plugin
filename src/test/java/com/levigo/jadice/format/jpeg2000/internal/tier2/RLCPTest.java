...
import static com.levigo.jadice.format.jpeg2000.internal.tier2.ProgressionOrder.RLCP;

import com.levigo.jadice.format.jpeg2000.internal.codestream.PacketHeader;

public class RLCPTest extends ProgressionOrderTestBase {

  @Override
  protected PacketJigsaw createPacketJigsaw() {
    final PacketJigsaw order = new PacketJigsaw(RLCP);
